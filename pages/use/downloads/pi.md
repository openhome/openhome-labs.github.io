...
<a href="http://builds.openhome.org/releases/openhome/pi/openhome-player-1.0.2_armhf.sh" download>Download __OpenHome Player for Raspberry Pi__</a>
</div>

If you prefer to download the Player via a terminal, simply type the following into your terminal window:

```wget http://builds.openhome.org/releases/openhome/pi/openhome-player-1.0.2_armhf.sh
```
